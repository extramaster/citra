...
static u32 homemenu_input_buffer = 0;
...
static u8 unknown_ns_state_field = 0;

static ScreencapPostPermission screen_capture_post_permission = ScreencapPostPermission::CleanThePermission;
...
void GetScreenCapPostPermission(Service::Interface* self) {
    ...
    cmd_buff[1] = RESULT_SUCCESS.raw;
    cmd_buff[2] = unknown_ns_state_field;
...
void Init() {
    ...
    screen_capture_post_permission = ScreencapPostPermission::CleanThePermission;
